...
namespace Prigitsk.Core.Nodes.Loading
{
    public class RepositoryData : IRepositoryData
    {
        ...
        public RepositoryData(Dictionary<string, Commit> commits, Dictionary<string, string> remotes, Dictionary<string, Commit> branches, Dictionary<string, Commit> tags)
        {
            _commits = commits;
            _remotes = remotes;
            _branches = branches;
